"""Test audio extraction from MP4 using FFmpeg subprocess."""

import subprocess
from pathlib import Path
import imageio_ffmpeg as ffmpeg  # pylint: disable=import-error
...
proc = subprocess.Popen(cmd, stdout=subprocess.PIPE, stderr=subprocess.PIPE)  # pylint: disable=consider-using-with
